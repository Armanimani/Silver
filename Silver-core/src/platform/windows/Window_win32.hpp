...
namespace silver::core
{
	...
	public:
		...
		uint screen_resolutionX() const noexcept override;
		uint screen_resolutionY() const noexcept override;

		void set_width(const uint width) noexcept override;
		void set_height(const uint height) noexcept override;
